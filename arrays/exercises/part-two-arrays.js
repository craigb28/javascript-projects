...
cargoHold[5]="space tether"
    // A more complicated way of making this happen is: cargoHold.splice(5,1,"space tether")  
            // The first number (5) is the starting index of the removal/replacement
            // The secon number (1) is the number of elements to be deleted.
            // The lest entry in the parentheses is what replaces the deleted elements. 
